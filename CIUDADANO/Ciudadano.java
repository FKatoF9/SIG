public class Ciudadano {
    ...
    public Ciudadano(String nombrecompleto, int edad, String ocupacion, String nomsectorcat,
                    boolean participa, String genero, String nivelEducativo) {
    ...
    public Ciudadano(String nombrecompleto, int edad) {
        ...
        // Opcional: quita el print si no lo necesitas
        System.out.println("Ciudadano creado con datos mínimos: " + nombrecompleto + ", Edad: " + edad);
    }

    public void saludar() {
        System.out.println("Hola, soy " + nombrecompleto + " y vivo en " + nomsectorcat);
    }
